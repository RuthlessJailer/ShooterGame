package dev.wesley.shooter.physics.component
...
import dev.wesley.shooter.physics.collision.system.CollisionSpawnSystem.Companion.SPAWN_AREA_SIZE
...
class PhysicComponent {
    ...
    companion object {
        ...
        fun EntityCreateCfg.physicComponentFromImage(
            ...
            image : Image,
            bodyType: BodyType,
            fixtureAction : BodyDefinition.(PhysicComponent, Float, Float) -> Unit) : PhysicComponent {
            val x = image.x
            val y = image.y
            val w = image.width
            val h = image.height
